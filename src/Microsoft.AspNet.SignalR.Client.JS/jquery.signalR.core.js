                ...
                try {
                    ...
                    transport.start(connection, function () { // success
                        ...
                        var isFirefox11OrGreater = signalR._.firefoxMajorVersion(window.navigator.userAgent) >= 11,
                            isSafari = signalR._.isSafari(window.navigator.userAgent, window.navigator.vendor),
                        ...
                        if (!initializationComplete) {
                            ...
                            if (!isSafari) {
                                ...
                                // Firing synchronous XHRs during beforeunload in Safari seems to work.
                                _pageWindow.bind("beforeunload", unloadHandler);
                            }
